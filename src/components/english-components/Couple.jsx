            ...
            <div className="row">
                <div className="col-lg-5" data-aos="fade-up">
                    ...
                    <div className="info groom-info">
                        <h3>
                            T. Mohammed Ziya, <sub>B.Tech.</sub>
                        </h3>
                        <p>
                            <strong>
                                Profession: Software Engineer at Trianz Pvt.
                                Ltd.
                            </strong>
                        </p>
                        <p>
                            Paternal Grand S/O Janab T. Ghouse Mohiuddin
                            Sahab(Late),
                            <br />
                            Maternal Grand S/O Janab Basheer Ahmed Sahab(Late).
                        </p>
                    </div>
                </div>
                <div
                ...
                <div className="col-lg-5" data-aos="fade-up">
                    ...
                    <div className="info">
                        ...
                        <p>
                            ...
                            <br />
                            Grand D/O Janab Alhaaj Abdur Rahman Sahab(Late),
                        </p>
                    </div>
                </div>
            </div>
